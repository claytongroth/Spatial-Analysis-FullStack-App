...
var LeafletReact = require('../leafletReact.js');

ReactDOM.render(React.createElement(LeafletReact, null), document.getElementById('main_container'));


},{"../leafletReact.js":2,"react":161,"react-dom":32}],2:[function(require,module,exports){
/** @jsx React.DOM */
var React = require('react');
var ReactDOM = require('react-dom');
var L = require('leaflet');

var DarkOverlay = React.createClass({displayName: "DarkOverlay",
	render : function(){
		return (
			React.createElement("div", {className: "dark_overlay"}, React.createElement("center", null, React.createElement("h1", null, "Please input a city name to start2")))
		);
	}
});
	...
	render : function(){
		...
		return (
			React.createElement("tr", null, 
				React.createElement("td", null, React.createElement("input", {onChange: this.toggle, className: "toggle", type: "checkbox", checked: this.props.tag.selected})), 
				React.createElement("td", null, React.createElement("label", null, this.props.tag.label)), 
				React.createElement("td", null, React.createElement("label", null, this.props.tag.location[0])), 
				React.createElement("td", null, React.createElement("label", null, this.props.tag.location[1])), 
				React.createElement("td", null, React.createElement("button", {onClick: this.delete, className: "destroy"}, "remove"))
			)
		);
	}
});

var LeafletReact = React.createClass({displayName: "LeafletReact",
	...
	render: function() {
		...
		if(this.state.tags.length == 0){
			dark_overlay = React.createElement(DarkOverlay, null)
		} 
		else{
			var rows = this.state.tags.map(function(tag,i){
				return React.createElement(Tag, {toggle: that.toggleItem, delete: that.deleteItem, tag: tag, id: i})
			});
		}
		...
		return ( 
			React.createElement("div", null, 
				...
				React.createElement("table", {className: "textCentered"}, 
...
},{"leaflet":30,"react":161,"react-dom":32}],3:[function(require,module,exports){
(function (process){
/**
